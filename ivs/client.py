...
#basic flight control
    ...
    def simGetElaspedTime(self):
        """
        Returns Elasped time since beginning of simulation

        Returns:
            float: Elasped time
        """
        return self.client.call('simGetElaspedTime')
    def simGetFrameCount(self):
        """
        Returns total frames count since beginning of simulation

        Returns:
            int: total frames count
        """
        return self.client.call('simGetFrameCount')
    def simIsPause(self):
        """
...
#sensor APIs
    ...
    def getRadarData(self, radar_name = '', vehicle_name = ''):
        """
        Args:
            radar_name (str, optional): Name of Radar to get data from, specified in settings.json
            vehicle_name (str, optional): Name of vehicle to which the sensor corresponds to

        Returns:
            RadarData:
        """
        return RadarData.from_msgpack(self.client.call('getRadarData', radar_name, vehicle_name))
...
#----------------------------------- Vehicle APIs ---------------------------------------------
class VSimClient(VehicleClient, object):
    def __init__(self, ip = "", port = 41451, timeout_value = 3600):
        super(VSimClient, self).__init__(ip, port, timeout_value)
...
#----------------------------------- Tank APIs ---------------------------------------------
    def setTrackControls(self, controls, vehicle_name = ''):
        """
        Control the Track using throttle, steering, brake, etc.

        Args:
            controls (TrackControls): Struct containing control values
            vehicle_name (str, optional): Name of vehicle to be controlled
        """
        self.client.call('setTrackControls', controls, vehicle_name)

    def getTrackState(self, vehicle_name = ''):
        """
        The position inside the returned TrackState is in the frame of the vehicle's starting point
        ...
        Returns:
            TrackState:
        """
        state_raw = self.client.call('getTrackState', vehicle_name)
        return TrackState.from_msgpack(state_raw)

    def getTrackControls(self, vehicle_name=''):
        """
        Args:
            vehicle_name (str, optional): Name of vehicle
        ...
        Returns:
            TrackControls:
        """
        controls_raw = self.client.call('getTrackControls', vehicle_name)
        return TrackControls.from_msgpack(controls_raw)
    

#----------------------------------- Multiwheeler APIs ---------------------------------------------
    def setMWControls(self, controls, vehicle_name = ''):
        """
        Control the Multiwheeler using throttle, steering, brake, etc.

        Args:
            controls (MWControls): Struct containing control values
            vehicle_name (str, optional): Name of vehicle to be controlled
        """
        self.client.call('setMWControls', controls, vehicle_name)

    def getMWState(self, vehicle_name = ''):
        """
        The position inside the returned TrackState is in the frame of the vehicle's starting point
        ...
        Returns:
            MWState:
        """
        state_raw = self.client.call('getMWState', vehicle_name)
        return MWState.from_msgpack(state_raw)

    def getMWControls(self, vehicle_name=''):
        """
        Args:
            vehicle_name (str, optional): Name of vehicle
        ...
        Returns:
            MWControls:
        """
        controls_raw = self.client.call('getMWControls', vehicle_name)
        return MWControls.from_msgpack(controls_raw)
    
#----------------------------------- Amphibious APIs ---------------------------------------------
    def setAPControls(self, controls, vehicle_name = ''):
        """
        Control the Amphibious using throttle, steering, brake, etc.

        Args:
            controls (APControls): Struct containing control values
            vehicle_name (str, optional): Name of vehicle to be controlled
        """
        self.client.call('setAPControls', controls, vehicle_name)

    def getAPState(self, vehicle_name = ''):
        """
        The position inside the returned TrackState is in the frame of the vehicle's starting point
        ...
        Returns:
            APState:
        """
        state_raw = self.client.call('getAPState', vehicle_name)
        return APState.from_msgpack(state_raw)

    def getAPControls(self, vehicle_name=''):
        """
        Args:
            vehicle_name (str, optional): Name of vehicle
        ...
        Returns:
            APControls:
        """
        controls_raw = self.client.call('getAPControls', vehicle_name)
        return APControls.from_msgpack(controls_raw)
    def waterAndLandSwitching(self,water_domain,vehicle_name=''):
        """
        Args:
            vehicle_name (str, optional): Name of vehicle
            water_domain:1-in the water domain;0-on the ground;2-in the switch duration
        Returns:
            void
        """
        self.client.call('waterAndLandSwitching',water_domain, vehicle_name)
